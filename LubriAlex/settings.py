"""
Django settings for LubriAlex project.
...
SECRET_KEY = 'django-insecure-a533sdgb$_h8e#pfxj+0a6&kp_mufxegq&m$j-mz)ro(@sg_s4'
...
WSGI_APPLICATION = 'LubriAlex.wsgi.application'
